...
const ProductCard = ({
  ...
  return (
    <div className="max-w-sm md:max-w-lg mx-auto md:mx-0 border rounded-md p-2 flex flex-col gap-3">
      <Image
        imageURL={imageURL}
        alt={"Product Name"}
      ...
      <div className="flex items-center flex-wrap space-x-1 mt-auto">
        {!colors.length ? (
