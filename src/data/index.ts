...
import { ColorNameTypes } from "../types";
...
export const productList: IProduct[] = [
  ...
  },
  {
    id: uuid(),
    title: "New camera",
    description: "Best full frame cameras in 2024 | Digital Camera",
    imageURL:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMXYVv_UlH4XG0m4xZ59DVwq8kCpH9wwe7KJvb8srKvA&s",
    price: "150",
    colors: ["#13005A", "#000000"],
    category: {
      name: "Camera",
      imageURL:
...
export const colors: ColorNameTypes[] = [
  "#a855f7",
  "#2563eb",
  "#84D2C5",
  "#13005A",
